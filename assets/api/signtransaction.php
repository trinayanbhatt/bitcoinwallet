...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS => "{\"method\":\"signrawtransaction\",\"params\":[\"$hex\", [{\"txid\":\"$txid\", \"vout\":$decodedvout,\"scriptPubKey\":\"$scriptHash\", \"redeemScript\": \"$redeemScript\"}],[\"$privateKey1\",\"$privateKey\"]],\"id\":1,\"chain_name\":\"$chain\"}",
